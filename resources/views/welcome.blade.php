...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/fonts/font-awesome/css/line-awesome.css')}}" type="text/css" media="all" />
...
<body>
    ...
    <header class="kf-header">
        ...
        <div class="kf-navbar-mobile">
            ...
            <div class="kf-main-menu">
                <ul>
                    <li><a href="#home" class="kf-menu-close" >Home</a></li>
                    <li><a href="#about" class="kf-menu-close" >About</a></li>
                    <li><a href="#menu" class="kf-menu-close" >Menu</a></li>
                    <li><a href="#gallery" class="kf-menu-close" >Gallery</a></li>
                    <li><a href="#blog" class="kf-menu-close" >Blog</a></li>
                </ul>
            </div>
    ...
    <div class="wrapper">
        ...
        <section class="section kf-started-slider" id="home">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">

                        <div class="kf-started-item">
                            <div class="slide js-parallax" style="background-image: url({{asset('assets/images/started_img_n6.jpg')}});"></div>
                            <div class="container">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="kf-started-item">
                            <div class="slide js-parallax" style="background-image: url({{asset('assets/images/started_img_n5.jpg')}});"></div>
                            <div class="container">
                                <div class="description align-left element-anim-1">
                                    <div class="subtitles">
                                        Welcome to the Kaffen
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="kf-started-item">
                            <div class="slide js-parallax" style="background-image: url({{asset('assets/images/started_img_n3.jpg')}});"></div>
                            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                        ...
                        <div class="kf-about-quote element-anim-1 scroll-animate" data-animate="active">
                            <img src="{{asset('assets/images/quote_img.png')}}" alt="" />
            ...
            <div class="container">
                ...
                {{-- <div class="kf-services-items row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                        <div class="kf-services-item element-anim-1 scroll-animate" data-animate="active">
                            <div class="image kf-image-hover">
                                <a href="services.html"><img src="{{asset('assets/images/service3.jpg')}}" alt="" /></a>
                            </div>
                            <div class="desc">
        ...
        <!-- Section Menu -->
        <section class="section kf-menu kf-menu-tabs" id="menu" style="background-image: url({{asset('assets/images/category_bg.jpg')}});">
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all hot-coffee">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/menu1.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/menu1.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all hot-coffee">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/menu2.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/menu2.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all dessert">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/menu3.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/menu3.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all hot-coffee">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/menu4.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/menu4.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all dessert">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/menu5.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/menu5.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all dessert">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/menu6.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/menu6.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all fast-food">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/ins_gal1.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/ins_gal1.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="kf-menu-item-col col-xs-12 col-sm-12 col-md-12 col-lg-6 all fast-food">
                            <div class="kf-menu-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/ins_gal3.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/ins_gal3.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
        ...
        <section class="section kf-choose section-bg">
            <div class="container">
                <div class="kf-parallax-icon pi-1" data-jarallax-element="-60">
                    <div class="p-icon" style="background-image: url({{asset('assets/images/parallax_icon1.png')}});"></div>
                </div>
                <div class="kf-parallax-icon pi-2" data-jarallax-element="-80">
                    <div class="p-icon" style="background-image: url({{asset('assets/images/parallax_icon2.png')}});"></div>
                </div>
                <div class="kf-parallax-icon pi-3" data-jarallax-element="-40">
                    <div class="p-icon" style="background-image: url({{asset('assets/images/parallax_icon3.png')}});"></div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="kf-choose-image element-anim-1 scroll-animate" data-animate="active">
                            <img src="{{asset('assets/images/choose_img.jpg')}}" alt="" />
                        </div>
                        ...
                        <div class="kf-choose-list">
                            <ul>
                                <li class="element-anim-1 scroll-animate" data-animate="active">
                                    <div class="icon">
                                        <img src="{{asset('assets/images/choose_icon1.png')}}" alt="" />
                                    </div>
                                    <div class="desc">
        ...
        <section class="section kf-grid-carousel" id="gallery">
            <div class="container">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="slide-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/grid_gal2.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/grid_gal2.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="slide-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/grid_gal3.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/grid_gal3.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="slide-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/grid_gal4.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/grid_gal4.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="slide-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/grid_gal5.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/grid_gal5.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
                                    <h5 class="name">Espresso</h5>
                                </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="slide-item element-anim-1 scroll-animate" data-animate="active">
                                <div class="image kf-image-hover">
                                    <a href="{{asset('assets/images/grid_gal1.jpg')}}" class="has-popup-image"><img src="{{asset('assets/images/grid_gal1.jpg')}}" alt="" /></a>
                                </div>
                                <div class="desc">
        ...
        <section class="section kf-testimonials kf-testimonials-2 section-bg" style="background-image: url({{asset('assets/images/testimonials_bg2.jpeg')}});">
            <div class="container">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="slide-item element-anim-1 scroll-animate" data-animate="active">
                                    <div class="image">
                                        <img src="{{asset('assets/images/rev2.jpg')}}" alt="" />
                                    </div>
                                    <div class="desc">
                                        <div class="stars">
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="slide-item element-anim-1 scroll-animate" data-animate="active">
                                    <div class="image">
                                        <img src="{{asset('assets/images/rev3.jpg')}}" alt="" />
                                    </div>
                                    <div class="desc">
                                        <div class="stars">
                                            <i class="fas fa-star"></i>
        ...
        <!-- Section Latest Blog -->
        <section class="section kf-latest-blog section-bg" id="blog">
            <div class="container">
                ...
                <div class="kf-blog-grid-items row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                        <div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
                            <div class="image kf-image-hover">
                                <a href="blog-single.html"><img src="{{asset('assets/images/latest_blog1.jpg')}}" alt="" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                        <div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
                            <div class="image kf-image-hover">
                                <a href="blog-single.html"><img src="{{asset('assets/images/latest_blog2.jpg')}}" alt="" /></a>
                            </div>
                            <div class="desc">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                        <div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
                            <div class="image kf-image-hover">
                                <a href="blog-single.html"><img src="{{asset('assets/images/latest_blog3.jpg')}}" alt="" /></a>
                            </div>
                            <div class="desc">
                                <h5 class="name">SWR React Hooks With Next Increm Ental Static Regeneration</h5>
                                <div class="kf-date"><i class="far fa-calendar-alt"></i>25 Sep 2021</div>
        ...
        <!-- Section CTA -->
        <section class="section kf-cta kf-parallax" id="booking" style="background-image: url({{asset('assets/images/cta_bg.jpg')}});">
            <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                    ...
                    <div class="kf-f-gallery element-anim-1 scroll-animate" data-animate="active">
                        ...
                        <ul>
                            <li>
                                <a href="{{asset('assets/images/grid_gal1.jpg')}}" class="kf-image-hover has-popup-image"><img src="{{asset('assets/images/grid_gal1.jpg')}}" alt="" /></a>
                            </li>
                            <li>
                                <a href="{{asset('assets/images/grid_gal2.jpg')}}" class="kf-image-hover has-popup-image"><img src="{{asset('assets/images/grid_gal2.jpg')}}" alt="" /></a>
                            </li>
                            <li>
                                <a href="{{asset('assets/images/grid_gal3.jpg')}}" class="kf-image-hover has-popup-image"><img src="{{asset('assets/images/grid_gal3.jpg')}}" alt="" /></a>
                            </li>
                            <li>
                                <a href="{{asset('assets/images/grid_gal4.jpg')}}" class="kf-image-hover has-popup-image"><img src="{{asset('assets/images/grid_gal4.jpg')}}" alt="" /></a>
                            </li>
                            <li>
                                <a href="{{asset('assets/images/grid_gal5.jpg')}}" class="kf-image-hover has-popup-image"><img src="{{asset('assets/images/grid_gal5.jpg')}}" alt="" /></a>
                            </li>
                            <li>
                                <a href="{{asset('assets/images/grid_gal6.jpg')}}" class="kf-image-hover has-popup-image"><img src="{{asset('assets/images/grid_gal1.jpg')}}" alt="" /></a>
                            </li>
                        </ul>
                    </div>
